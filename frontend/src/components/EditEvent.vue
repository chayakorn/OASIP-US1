...
const time = ref(props.item.eventStartTime)
    ...
    <div class="grid grid-cols-2 divide-x-2">
      ...
      <div>
        ...
        <div class="flex py-1 pl-4 pt-0.5">
          ...
          <div
            class="flex-none bg-[#F1F3F4] rounded-2xl w-4/5 py-2 px-4 text-[#C6CACC]"
          >
            {{ item.categoryName }}
          </div>
        </div>
        ...
        <div class="flex pl-4 py-1">
          ...
          <div class="flex pl-4">
            ...
            <div
              class="flex-none bg-[#F1F3F4] rounded-2xl w-36 py-2 px-4 text-[#C6CACC]"
            >
        ...
        <div class="flex pl-4 py-1">
          ...
          <div class="flex-none rounded-2xl w-60 py-2 px-4 text-black-700">
              <span class="font-semibold">Comfirm Time: <br>
            {{
      ...
      <div>
        ...
        <div class="flex py-1 pl-9">
          ...
          <div
            class="flex-none bg-[#F1F3F4] rounded-2xl w-10/12 py-1.5 px-4 text-[#C6CACC]"
          >
            {{ item.name }}
          </div>
        </div>
        ...
        <div class="flex py-1 pl-9">
          ...
          <div
            class="flex-none bg-[#F1F3F4] appearance-none rounded-2xl w-10/12 py-2 px-4 text-[#C6CACC]"
          >
            {{ item.bookingEmail }}
          </div>
        </div>
    ...
    <div class="grid grid-cols-2 pt-4">
      ...
      <div class="justify-self-end px-4" @click="showCancelFn()">
        ...
        >
          ...
          ><span class="px-3 text-lg">CANCEL</span>
        </button>
      </div>
      <!-- EDIT -->
      <div class="px-4" @click="prevent(event, item.id)">
        ...
        >
          ...
          ><span class="px-6 text-lg">SAVE</span>
        </button>
      </div>
    </div>
