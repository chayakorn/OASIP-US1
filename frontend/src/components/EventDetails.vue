...
<template>
  <div
    class="bg-black/25 overflow-x-hidden overflow-y-auto absolute inset-0 z-50 outline-none focus:outline-none justify-center items-center flex">
  
      <div class="modal-container bg-white w-9/12 px-5 pt-4 pb-20 rounded-3xl">
