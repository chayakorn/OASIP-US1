...
// const date = moment.utc(item.eventStartTime).format('DD MMM YYYY')
// let startTime = moment.utc(item.eventStartTime).format('h:mm A')
// const durationTime = moment.utc(item.eventDuration)
...
<template>
  <div
    class="bg-black/25 overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none justify-center items-center flex"
  >
          ...
          <div class="modal-body">
            ...
            <div class="grid grid-cols-2 divide-x-2">
              ...
              <div>
                ...
                <!-- EMAIL -->
                <div class="flex py-1 pl-9">
                  <span class="text-[#5E6366] p-2 pr-3 font-semibold"
                    >Email</span
                  >
                  <div
